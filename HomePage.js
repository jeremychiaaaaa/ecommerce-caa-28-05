            ...
            name='Check Out' component={CheckOutStack} options={{
                tabBarIcon : ({color,size,focused}) => (
                    ...
                    <TouchableOpacity onPress={() => {
                       ...
                       }} style={{borderWidth:1, width:40, height:40, borderRadius:20, borderColor:'transparent',justifyContent:'center',alignItems:'center', backgroundColor:focused ? 'rgb(72,209,204)' : '#fff'}}>
